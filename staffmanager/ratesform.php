...
$strpageheading = get_string('bookform', 'local_staffmanager');
...
if ($label&&$id){
    $DB->delete_records('local_staffmanager_rates', ['id'=>$id]);
    redirect('/local/staffmanager/rates.php');
}
  ...
  if ($mform->is_cancelled()) {
    ...
    //In this case you process validated data. $mform->get_data() returns data posted in form.
     ...
     if ($id) {
          ...
          $obj->userdatafile = $fromform->userdatafile;
